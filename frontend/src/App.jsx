          ...
          <>
            {!result ? (
              <>
                ...
                <div className="privacy-note-line" style={{ textAlign: "center", margin: "12px 0 20px", fontSize: "12.5px", color: "var(--color-success)", fontWeight: "700" }}>
